...
def get_operation():
    ...
    if op.casefold() in add:
        return 'add'
    elif op.casefold() in subtract:
        return 'subtract'
    elif op.casefold() in multiply:
        return 'multiply'
    elif op.casefold() in divide:
        return 'divide'
    elif op.casefold() in power:
        return 'power'
    elif op.casefold() in sqroot:
        return 'sqroot'
    else:
